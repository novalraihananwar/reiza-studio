...
const demos: Record<string, DemoEntry> = {
  ...
  coffee: {
    ...
    desc: 'Dashboard admin POS coffee shop — kelola order, meja, dan inventori',
    iframeSrc: 'https://rehan-coffeshop-system-prototype.vercel.app/admin/dashboard',
    isStatic: true,
    tag: 'POS Admin',
    gradient: 'from-amber-500 to-orange-500',
  },
  'coffee-customer': {
    title: 'Menu Digital — Rehan Café (Meja 1)',
    desc: 'Tampilan pelanggan via QR code meja — pesan menu langsung dari HP',
    iframeSrc: 'https://rehan-coffeshop-system-prototype.vercel.app/table/table-1',
    isStatic: true,
    tag: 'Customer View',
